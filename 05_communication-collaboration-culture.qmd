...
- Claire McKay Bowen, Senior Fellow and lead of the statistical methods group at the Urban Institute.
- Claire McKay Bowen, Senior Fellow and lead of the statistical methods group at the Urban Institute. I focus on developing technical and policy solutions to safely expand access to confidential data for advancing evidence-based policymaking.
...
In addition to this framwork, make sure to choose an appropriate time and place for the conversation.
...
I'm following up on my question about how to adjust my slides to stay within the time limit while providing enough content for the JASON audience. I've never attended a JASON event, which is why I'm asking these questions.
...
Just checking in regarding the status of our IRB document copyedit. We know things can get busy, especially for COMMS, so if you're feeling overwhelmed, do you think it would be helpful for us to reach out to someone else at COMMS for support? Please let us know!
...
For example, while I prefer to be called Claire, I dislike being called Miss Bowen, as I have never been Miss Bowen (married name). In an academic setting, if you're unsure whether the instructor has a PhD, use Dr. or Professor.
