...
![](www/images/introduction-inigo.gif){#fig-hello fig-align="center"}
...
Similarly in @glickman2011great, the "hello" be three parts:

- Introduction
- Purpose of your call or email
- Key question

I will focus on these three parts.
...
Here's another example, this time introducing two individuals I know to each other. I've even embedded links to help them learn more about each and their work as well as relevant references.
...
- Is this a good time to talk about the updates to performance management?
...
The following is an email from a colleague who had asked me about how to explain another privacy concept, differential privacy, at a high level for a presentation. Below is his response after I took the time to provide him with a high-level conceptual example. Notice that Lance thanked me several times throughout the email, which I bold.
...
The following is an email after I met with a recent graduate who was interested in what it is like to work at the Urban Institute.
...
> Every conversation presents an opportunity to build upon and expand your network. With each new itneraction, you have an opportunity to establish or build rapport and leverage professional relationships going forward. Building on the "thank you" is where the tru skill comes in.
...
After the staff thanked me for my time, I concluded the conversation by extending an invitation for the staff members at the Washington State Department of Health to reach out if they had any further questions.
:::

I met a colleague at a workshop, and we discussed a job posting in his organization and his difficulties finding qualified candidates. I offered to help spread the word if he forwarded me the posting, which is my forward momentum that the colleague seized with sending an email that evening.
...
In @glickman2011great, she describes three broad areas for providing a foolproof download, which is the most common form of communication you'll use to share information with your coworkers and colleagues.
...
- **Be concise.** No one lies to read a one-page email or listen to four-minute voice mail if he/she/they doesn't have to. Be short and sweet, and to the point.
...
The following is an email from my colleague to our client about updating the bi-weekly check-ins for the ACCESS project.
...
[^NCSES]: Stands for National Science Foundation National Center for Science and Engineering Statistics.
...
Below is part of an email exchange, where there was confusion about payments for a contract between the American Statistical Association and Urban Institute (my project). In this email, I try to establish what is known, figure out what we are missing, and identify the next steps.
...
I am ok pushing this out further. However, Monday is Memorial day, so let's aim for full release Tuesday, May 28.

Updated timeline below:

- Bob and Tim to review the remaining comments to ensure the changes didn't change the meaning (EOD, today, May 23).
...
- Invitation to Speak at Urban on Propensity Score Methods
- Doug's Question on Practice Areas
- CONTRACT SIGNED 2/16/24, 0219393.000, 003
- Hold: SED Syn Focus Group

### Never send an angry or contentious email.

Email is a severely limited medium when it comes to conveying tone, which is why angry emails are never a good idea. More often than not, they just create more anxiety – and more email.

Occasionally, writing an angry email can be therapeutic. If this is the case, write it as a draft to get it off your chest, and then delete the email. When a confrontation is brewing, a conversation in person or on the phone is almost always best. Emails leave too much room for misunderstanding.
...
::: {.callout-important}
Don't pull a Dr. Lamere! She accidentally hit reply all about ordering commencement regalia, and it was sent to all full time faculty, part time faculty, and bookstore email lists.

![](www/images/alicia-replyall.png){#fig-replyall fig-align="center"}
