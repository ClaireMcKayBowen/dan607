...
![Futurama Fry meme with the text, "Not sure if the lack of communication is intentional or if people are genuinely struggling with it."](www/images/not-sure-communication.jpg){#fig-lack-communication fig-align="center"}

As a valuable resource, I strongly suggest reading "Great on the Job" by Jodi Glickman [@glickman2011great]. This book offers excellent insights on improving workplace communication, which I've personally found beneficial in my professional interactions.
...
![One of the most famous quotes from the movie, "The Princess Bride," where the Inigo Montoya faces the man who killed his father.](www/images/introduction-inigo.gif){#fig-hello fig-align="center"}
...
![David Rose from the TV Show, Schitt's Creek, asking, "Question."](www/images/question.gif){#fig-question fig-align="center"}
...
I'm Karen, a program manager for the project. Per our meeting, I need you to work with Jeff and Brandon to give me yours' and your team's FTE[^FTE] to finalize the budget. Give me that information by COB[^COB] 5/12.
...
![Really, Karen?](www/images/karen.gif){#fig-karen fig-align="center"}
...
![Thank you, thank you, thank you from Ke Huy Quan at the 2024 Oscars](www/images/thank-you-thank-you-thank-you.gif){#fig-thank-you fig-align="center"}
...
![Otter Goodbye from Samsung Mobile](www/images/remember-me.gif){#fig-thank-you fig-align="center"}
...
![Professor Farnsworth, a character on the TV show, "Futurama," saying "Good news, everyone."](www/images/good-news.gif){#fig-good-news fig-align="center"}
...
![From the Dungeons & Dragons TV show, "Encounter Party!", where someone is saying, "Can I roll persuasion?"](www/images/roll-persuasion.gif){#fig-roll fig-align="center"}
...
What could be done to this email to make it better?
...
[^JSM]: The [Joint Statistical Meetings](https://www.amstat.org/meetings/joint-statistical-meetings) is the largest gathering of statisticians in the world and hosted in North America.
...
![From the movie, "Anchorman," where Ron Burgundy is saying, "That doesn't make any sense."](www/images/that-doesnt-make-any-sense.gif){#fig-sense fig-align="center"}
...
![Cat typing on a laptop keyboard.](www/images/cat-typing.gif){#fig-cat-typing fig-align="center"}
...
1. The conference website is updated to include a schedule page, a registration page, and an updated support page. Please take a look and let us know if any updates are needed.
...
- Will and Ethan to review the remaining comments to ensure the changes didn't change the meaning (EOD[^EOD], today, May 23).
...
RFS[^RFS] on AI[^AI] dropped! Due May 10.
...
![Rick, from "Rick and Morty," typing angerly.](www/images/rick-typing.gif){#fig-rick-typing fig-align="center"}
