...
students <- c("Androlewicz", "Boyar", "Choate", "Clayman", "Cousins", "Daversa", 
              "Dowdy", "Duhil de Benaze", "Espinal-Guzman", "Gallishaw", "Garratt", "Kim",
              "Morris", "Mueller", "O’Brien", "OKeefe", "Pacheoco",
              "Pushard", "Scott", "Thadeio", "Thorbahn", "Washington")

n <- length(students)

audience <- c("family-friends", "classmates-coworkers",
              "funders-media", "local-government-policymaker")
