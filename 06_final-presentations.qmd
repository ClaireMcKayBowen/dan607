...
|-------------------|------------------------------|--------------------|
| Bennett           | Family/Friends                | Workforce Equity and Ethical Oversight in Emerging Technology Pipelines |
| DiSandro          | Nonprofit/Community Leaders   | Qantas data breach, with a deeper dive into what happened and what privacy and security measures could have been taken |
| Gentile           | Family/Friends                | TBD |
| Hayes             | Family/Friends                | Data representation and quality are important and how they affect our communities |
| Imperati          | Classmates/Coworkers         | Change Healthcare data leak |
| Possamai          | Government/Policymakers      | TBD |
| Ricket            | Classmates/Coworkers         | TBD |
| Rioux             | Classmates/Coworkers         | TBD |
| Rossi             | Family/Friends                | Security and Privacy with Social Media Platforms |
| Santosh           | Government/Policymakers      | Privacy, data governance, and ethical issues surrounding fitness trackers and smartwatches |
| Spadea            | Family/Friends                | Data Governance; Smartphone apps for monitoring students |
| Sudoval           | Nonprofit/Community Leaders   | Stingray trackers/towers |
| Trotta            | Media/General Public          | Public safety vs. privacy of Ring doorbell data sharing |
| Wadsworth         | Government/Policymakers      | AI advancement over the past 10 years |
...
-- | Rossi
-- | Hayes
**8:10 pm - 8:15 pm** | **Break**
8:15 pm - 8:45 pm | Bennett
-- | Rioux
-- | Trotta
-- | Wadsworth
-- | Santosh
...
After all the presentations are complete, please submit your vote [here](https://forms.gle/ribGK3EhgUKXEozNA).