---
title: "Security, Privacy, Ethics, and Equity"
format: 
  html:
    toc: true
...
Complete this [17 true-or-false question quiz](https://forms.gle/GMfexETbiQejU9E99) created by researchers from the Annenberg School for Communication at the University of Pennsylvania [@turow2023americans]. You will have 6 minutes to complete it (it should take you roughly 3 to 4 minutes).
:::
...
- Does the scenario you mentioned apply all people or only to a specific subgroup of individuals? Why or why not?
- Could the scenario you brought up be used for a public good? If so, what changes would be necessary concerning security, privacy, ethics, and equity?
- What implications does security, privacy, ethics, and equity mean to you in this scenario?

:::

:::{.callout-important}
Did you notice that the AI narrator in "Coded Bias" speaks with a female voice. Consider other AI interfaces we interact with daily. Do they also predominantly feature a female voice? What biases might this perpetuate within society?
:::
...
Prior to starting this course, how would you have defined data security, privacy, ethics, and equity? How has your definition of these different terms changed since the assignments and these discussions? Why or why not?
...
- data analysis and dissemination (weeks 4 and 5)
