...
Privacy-Enhancing Technologies (PETs) are critical tools for ensuring responsible data stewardship. They help uphold data privacy and security best practices while maintaining compliance with data privacy laws.

Privacy is not only a technical concern but a **social contract** — between data curators and the individuals whose data is being used. Ethical data use demonstrates accountability to your constituents and broader society.
...
**Important:**  
PETs are *not plug-and-play*. Their **effectiveness depends on how they’re implemented** and **how they’re combined** with other techniques.

:::

#### Two Broad Classes of PETs

Privacy-Enhancing Technologies generally fall into two overlapping categories:

**1. Privacy of the Output:** reducing disclosure risks associated with specific data and/or data byproducts. Common techniques are...

- **De-identification** - Removing or converting direct identifiers (e.g., names, SSNs).

- **Statistical Disclosure Control (SDC)** - Methods of privacy and confidentiality for output statistics and data. Examples include...

    - **Differential Privacy (DP)** - a formal privacy metric framework that analyzes data release processes a priori and paramterizes the privacy protections provided by them.
...
**2. Privacy of the Computation:** reducing disclosure risks associated with the creation of data and/or data byproducts. Common techniques are...

- **Secure Multi-party Computation** - subfield of cryptography with the goal of creating methods for parties to jointly compute a function over their inputs while keeping those inputs private.
- **Federated Learning** - a machine learning technique where multiple clients collaboratively train a model on decentralized, non-identically distributed data without sharing their raw data.
- **Trusted Execution Environments** - a secure area within a main processor that protects code and data by ensuring confidentiality and integrity, even from the device owner.
- **Zero-Knowledge Proofs** - a protocol where one party proves to another that a statement is true without revealing any information beyond the truth of the statement itself.
...
![Fictitious Santa Fe, NM, Socioeconomic Data](www/images/03_socio-data.png){#fig-socio-data fig-align="center"}
...
![Removing personally identifiable information](www/images/03_socio-data-pii.png){#fig-socio-data-pii fig-align="center"}
...
![Rounding income](www/images/03_socio-data-rounding.png){#fig-socio-data-rounding fig-align="center"}
...
![Generaliziation](www/images/03_socio-data-generalization.png){#fig-socio-data-generalization fig-align="center"}
...
![Infusing noise](www/images/03_socio-data-adding-noise.png){#fig-socio-data-noise fig-align="center"}
...
![Trump's Executive Order on "Stoping Waste, Fraud, and Abuse by Eliminating Information Silos".](www/images/03_trump-eo-data-silos.png){#fig-trump-eo-data-silos fig-align="center"}
...
exercise_number <- exercise_number + 1
```
The March 20, 2025, Executive Order titled “Stopping Waste, Fraud, and Abuse by Eliminating Information Silos” directs federal agencies to remove barriers that restrict access to unclassified government data, with the goal of improving efficiency, reducing duplication, and strengthening fraud detection. It mandates that agency heads ensure designated federal officials have broad, timely access to data and IT systems, and that outdated policies or regulations hindering intra- and inter-agency data sharing be modified or rescinded. The order also extends to data held by state programs receiving federal funds and prioritizes a review of classification practices to prevent unnecessary restrictions. While emphasizing legal compliance, the EO promotes centralized access and oversight to enhance administrative performance.

1. From a privacy, security, and ethical perspective, what are the potential risks and benefits of granting "unfettered access" to unclassified government data across federal and state agencies, especially when third-party systems are involved?

2. How might increased data sharing improve government efficiency and fraud detection, and what tradeoffs might exist with regard to data security and individual rights?

3. What governance, oversight, or technical safeguards would you recommend to balance transparency, utility, and privacy in implementing this executive order?
