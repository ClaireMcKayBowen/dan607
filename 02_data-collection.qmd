...
![A data lifecycle diagram highlighting the 'Data collection and acquisition' phase in blue, with all other phases faded out. This stage refers to designing and obtaining data from various sources.](www/images/data-lifecycle-collection.png){#fig-data-collection fig-align="center" width=100%}
...
![A colorful circular diagram of the data lifecycle, showing six stages: data collection and acquisition, data storage, data sharing and transfer, data analysis, data dissemination, and data destruction and archival.](www/images/data-lifecycle.png){#fig-data-lifecycle fig-align="center" width=80%}
...
1. What was your example of unethical or harmful data use, and who was most affected?

2. How might applying principles from the readings thus far (e.g., Do No Harm or privacy-enhancing methods) have changed the outcome?

3. What lessons should data practitioners or analysts take away from this case to prevent similar issues in the future?
...
This quote from a colleague highlights the importance of how data are collected. If we blindly collect data without careful consideration of the process—such as how we define groups or the methods used for data collection—we could severely and negatively impact those groups when others in the data ecosystem use and analyze that data.

The required reading assignment, Do No Harm Guide (DNHG) by @schwabish2023no, covers many data collection challenges and will facilitate our discussion on the potential security, privacy, ethical, and equity issues in data collection.

![The cover of the Urban Institute report, "Do No Harm Guide: Collecting, Analyzing, and Reporting Gender and Sexual Orientation Data ."](www/images/02_dnhg-sogi.png){#fig-dnhg-sogi fig-align="center" width=60%}
...
Write (600 to 1200 words): Choose a community you belong to (e.g., your hometown, childhood community, or Stonehill College) and identify how it uses public federal datasets (e.g., from the U.S. Census Bureau, Department of Transportation, etc.) to inform a policy decision.
