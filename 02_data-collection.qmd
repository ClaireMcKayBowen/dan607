...
### Security, privacy, ethics, and equity
...
![The cover of the Urban Institute report, "Do No Harm Guide: Collecting, Analyzing, and Reporting Gender and Sexual Orientation Data ."](www/images/dnhg-sogi.png){#fig-dnhg-sogi fig-align="center" width=60%}
...
![2020 Census Race Question](www/images/rsblog-race-hispanic-origin-figure-2.jpg){#fig-2020-census-race fig-align="center" width=80%}
...
![The image from Mimi Ọnụọha's The Library of Missing Datasets 3.0](www/images/mo_the-library-of-missing-datasetss-v-3.0_01_rt.jpg){#fig-1990-census-race fig-align="center" width=50%}
...
![Roll Safe Think About It meme that says, "Can't have any issues, if there is no data."](www/images/no-data.jpg){#fig-no-data fig-align="center" width=80%}
